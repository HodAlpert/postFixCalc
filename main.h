...
extern struct bignum* calcSumWithoutFree(struct bignum* first,struct bignum* second);
extern struct bignum* calcSubWithoutFree(struct bignum* first,struct bignum* second);
